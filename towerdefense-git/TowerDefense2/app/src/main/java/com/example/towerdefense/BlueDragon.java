...
public class BlueDragon extends Enemy{
    ...
    public BlueDragon(Context context, ArrayList<Elements> path) {
        super(BitmapFactory.decodeResource(context.getResources(), R.drawable.bluedragon_sprite), 5, 2, 2, path);
        this.value = 4;
        this.cost = 40;

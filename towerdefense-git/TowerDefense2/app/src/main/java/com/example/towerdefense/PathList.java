        ...
        for (int x = 0; x < mapMatrix.length; x++) {
            for (int y = 0; y < mapMatrix[0].length; y++) {
                ...
                if (mapMatrix[x][y].equals("1")) {
                    path1.set(1, new Path((double) map.getBlockSizeX() * x,(double) map.getBlockSizeY() * y, context ));
                    Log.d(TAG, "PATH" + path1);
                }
                ...
                if (mapMatrix[x][y].equals("5")) {
                    path2.set(0, new Path((double) map.getBlockSizeX() * x,(double) map.getBlockSizeY() * y, context ));

...
public class Pikachu extends Enemy {
    ...
    private static final String TAG = Pikachu.class.getSimpleName();

    public Pikachu(Context context, ArrayList<Elements> path) {
        super(BitmapFactory.decodeResource(context.getResources(), R.drawable.pikachu_sprite), 5, 2, 2, path);
        this.value = 4;
        this.cost = 40;
